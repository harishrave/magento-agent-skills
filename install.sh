...
# Installs all skills (magento-module, magento-admin-ui, magento-audit, magento-browser-testing) at once.
#
# Usage:
...
usage() {
    ...
    echo ""
    echo "Installs all skills: magento-module, magento-admin-ui, magento-audit, magento-browser-testing"
    echo ""
...
echo ""
echo "Installed:"
for skill in magento-module magento-admin-ui magento-audit magento-browser-testing; do
